...
<head>
    ...
    <title>Login - SIKANTI BPK Jambi</title>
    ...
    <style>
        ...
        /* ================= TAMPILAN KHUSUS HP (BOTTOM SHEET) ================= */
        @media (max-width: 991px) {
            /* Ubah background layar belakang menjadi gelap */
            .login-wrapper {
                background: linear-gradient(135deg, #020617 0%, #0f172a 40%, #1e3a8a 100%);
                flex-direction: column;
                justify-content: flex-end; /* Form ditekan ke bawah */
            }
            /* Hilangkan warna putih di layar penuh */
            .login-right {
                background-color: transparent !important;
                padding: 0;
                align-items: flex-end; /* Memastikan kotak menempel di bawah */
            }
            /* Ubah Form menjadi kotak melengkung bergaya Bottom Sheet */
            .login-form-box {
                background-color: #ffffff;
                border-radius: 35px 35px 0 0;
                padding: 40px 30px 20px 30px;
                min-height: 70vh; /* Tinggi form 70% dari layar */
                box-shadow: 0 -15px 40px rgba(0,0,0,0.25);
                position: relative; /* Penting untuk trik CSS di bawah */
                margin: 0;
                max-width: 100%;
            }
            /* TRIK AJAIB: Tarik elemen header mobile KELUAR dari kotak putih ke area gelap */
            .login-form-box > .text-center.d-block.d-lg-none {
                position: absolute;
                top: -20vh; /* Ditarik ke atas kotak putih */
                left: 0;
                right: 0;
            ...
            /* Ubah teks SIKANTI menjadi putih menyala */
            .login-form-box > .text-center.d-block.d-lg-none h4 {
            ...
            /* Perbesar logo di HP agar terlihat gagah */
            .app-logo-mobile {
                max-width: 90px;
                max-height: 90px;
                filter: drop-shadow(0 0 25px rgba(96, 165, 250, 0.6));
            }
            /* Sesuaikan margin form agar rapi */
            .greeting-text {
                font-size: 1.8rem;
                margin-top: 10px;
            }
...
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="col-lg-6 col-12 login-right">
            <div class="login-form-box">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group mb-3">
                        <label class="font-weight-bold small text-uppercase w-100 d-flex justify-content-between align-items-center" style="letter-spacing: 1px; color: #64748b; margin-bottom: 8px;">
                            ...
                            <a href="#" onclick="lupaSandiAlert(event)" class="text-decoration-none text-capitalize" style="letter-spacing: 0; font-weight: 600; color: #3b82f6; transition: 0.2s; font-size: 0.85rem;" onmouseover="this.style.color='#1d4ed8'" onmouseout="this.style.color='#3b82f6'">Lupa Sandi?</a>
                    ...
                    <div class="form-group d-flex justify-content-between align-items-center">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="remember" style="font-size: 0.85rem; color: #475569; font-weight: 500;">
                ...
                <div class="text-center mt-4 pt-3 border-top small" style="color: #94a3b8; font-weight: 500; border-color: #f1f5f9 !important; font-size: 0.8rem;">
    ...
    <script>
        function lupaSandiAlert(e) {
            e.preventDefault(); 
            Swal.fire({
                icon: 'info',
                title: 'Lupa Kata Sandi?',
                text: 'Untuk alasan keamanan, silakan hubungi Administrator masing-masing subbagian BPK Perwakilan Provinsi Jambi untuk melakukan reset kata sandi akun Anda.',
